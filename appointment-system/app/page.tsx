...
// ✅ Import IAppointment from the List component to avoid conflicts
import AppointmentList, { IAppointment } from '@/components/AppointmentList';
      ...
      >
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-(--foreground)">
            {editingAppointment ? 'Update Appointment' : 'Book Your Appointment'}
          </h2>
          {editingAppointment && (
            <button 
              onClick={() => setEditingAppointment(null)}
              className="text-sm text-(--primary) underline mt-2 hover:opacity-80"
            >
              Cancel Edit
            </button>
          )}
